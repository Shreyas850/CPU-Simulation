...
VL_INLINE_OPT void Vpc___024root___nba_sequent__TOP__0(Vpc___024root* vlSelf) {
    ...
    // Body
    vlSelf->pc_out = ((IData)(vlSelf->reset) ? 0U : 
                      (0xffU & ((IData)(1U) + (IData)(vlSelf->pc_out))));
}
...
#endif
            VL_FATAL_MT("pc.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("pc.v", 1, "", "Active region did not converge.");
            }
