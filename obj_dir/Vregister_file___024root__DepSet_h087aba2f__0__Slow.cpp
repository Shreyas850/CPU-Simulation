...
#endif
            VL_FATAL_MT("register_file.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vregister_file___024root___ctor_var_reset(Vregister_file___024root* vlSelf) {
    ...
    vlSelf->write_addr = VL_RAND_RESET_I(2);
    vlSelf->write_data = VL_RAND_RESET_I(8);
    vlSelf->read_addr_a = VL_RAND_RESET_I(2);
    vlSelf->read_addr_b = VL_RAND_RESET_I(2);
    vlSelf->read_data_a = VL_RAND_RESET_I(8);
    vlSelf->read_data_b = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->register_file__DOT__registers[__Vi0] = VL_RAND_RESET_I(8);
    }
